...
export const About = () => {
  return (
    <section id='about'>
      <div className='flex justify-between ring-1 ring-white/20 py-28 px-8 bg-linear-to-tr from-background to-white/20'>
        ...
        <div className='flex flex-col justify-center py-4 px-8 w-1/2'>
          ...
          <p className='font-main text-xl text-gray-300 mt-8 leading-8'>
            ...
            eligendi eum quos perspiciatis, voluptate eveniet minus labore porro
            amet modi sapiente iste earum totam asperiores excepturi. Aliquam
            laborum corporis ducimus! Lorem, ipsum dolor sit amet consectetur
            adipisicing elit.
          </p>
      ...
      <div className='p-8'>
        <div className='flex items-center gap-3'>
          ...
          <hr className='h-0.5 w-3/4 bg-linear-to-r from-accent3/40 to-background border-0' />
        </div>
      </div>
    </section>
  );
